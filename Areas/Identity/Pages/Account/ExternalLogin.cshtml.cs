...
namespace BlazorIdentity.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<BlazorIdentityUser> _userStore;
        private readonly IUserEmailStore<BlazorIdentityUser> _emailStore;
        private readonly IEmailSender _emailSender;
        private readonly ILogger<ExternalLoginModel> _logger;

        public ExternalLoginModel(
            SignInManager<BlazorIdentityUser> signInManager,
            UserManager<BlazorIdentityUser> userManager,
            IUserStore<BlazorIdentityUser> userStore,
        ...
        private BlazorIdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(BlazorIdentityUser)}'. " +
                    $"Ensure that '{nameof(BlazorIdentityUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
        ...
        private IUserEmailStore<BlazorIdentityUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<BlazorIdentityUser>)_userStore;
        }
    }
}
